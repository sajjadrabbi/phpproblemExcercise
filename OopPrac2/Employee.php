...
class Employee
{
    ...
    {
        //$this is a special variable which can be used to acess class properties
...
$emp1 = new Employee(); //created a instance of an object
$emp1->id = 101;
...
$emp2 = new Employee(); //created a instance of an object
$emp2->id = 201;
$emp2->name = "Ronal Komen";
$emp2->totalLeaveTaken = 5;
